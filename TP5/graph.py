...
def plot_data(thread_counts, num_cycles, base_path):
    ...
    plt.ylabel("CPU Cycles Simulated")
    plt.title("CPU Cycles vs Number of Threads")
    plt.grid()
    
    save_path = os.path.join(base_path, f"q5_{thread_counts}.png")
...
def main():
    ...
    print(thread_counts, num_cycles)
